...
if __name__ == '__main__':
    ...
    parser.add_argument("-source_root", "--source_root", help = "specify your source dir", default = r"C:\Users\Dell Precision 7510\Desktop\cong_viec_o_truong\Do_an_tot_nghiep\do_an_khoa_truoc\github-arcface-mobilenetv2 - Copy\Face_main\data\student", type = str)
    parser.add_argument("-dest_root", "--dest_root", help = "specify your destination dir", default = r"C:\Users\Dell Precision 7510\Desktop\cong_viec_o_truong\Do_an_tot_nghiep\do_an_khoa_truoc\github-arcface-mobilenetv2 - Copy\Face_main\data\student_aligned", type = str)
    parser.add_argument("-crop_size", "--crop_size", help = "specify size of aligned faces, align and crop with padding", default = 160, type = int)
